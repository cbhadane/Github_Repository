...
Browser("Advantage Shopping_2").Page("Advantage Shopping").Sync @@ hightlight id_;_Browser("Advantage Shopping_2").Page("Advantage Shopping")_;_script infofile_;_ZIP::ssf9.xml_;_
Browser("Advantage Shopping_2").CloseAllTabs @@ hightlight id_;_67072_;_script infofile_;_ZIP::ssf10.xml_;_
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("Quantity").Set DataTable("_2", dtGlobalSheet) @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("WebElement")_;_script infofile_;_ZIP::ssf3.xml_;_
